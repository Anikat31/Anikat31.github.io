  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar-name-native {
      ...
      font-style: italic; color: rgba(247,244,239,0.45);
      margin-top: 0.2rem;
    }

    .sidebar-role {
      font-size: 0.82rem; font-family: var(--mono);
      color: rgba(247,244,239,0.5); line-height: 1.6;
      margin-top: 0.5rem;
    }

    .sidebar-nav {
      display: flex; flex-direction: column;
      gap: 0.1rem; margin-top: auto;
    }

    .sidebar-nav a {
      font-family: var(--mono); font-size: 0.78rem;
      color: rgba(247,244,239,0.45); text-decoration: none;
    ...
    .sidebar-contact { display: flex; flex-direction: column; gap: 0.5rem; }
    ...
    .sidebar-contact svg { width: 13px; height: 13px; fill: currentColor; flex-shrink: 0; }
    ...
    /* About */
    #about .lead { font-size: 1.15rem; line-height: 1.85; }
    ...
    #about .interest-item::before {
      content: '—'; color: var(--ink-light);
      font-family: var(--mono); font-size: 0.75rem; flex-shrink: 0;
    }
    ...
    .pub-num {
      font-family: var(--mono); font-size: 0.78rem;
      color: var(--ink-light); padding-top: 0.2rem; text-align: right;
    }
    ...
    .pub-authors {
      ...
      font-style: italic; margin-bottom: 0.6rem; line-height: 1.55;
    }

    .pub-authors strong { font-style: normal; font-weight: 600; color: var(--ink); }
    ...
    .badge-arxiv {
      ...
      border: 1px solid #e8c0c0; border-radius: 3px;
      padding: 2px 10px; text-decoration: none; letter-spacing: 0.02em;
      transition: background 0.15s;
    }

    .badge-arxiv:hover { background: #efd4d4; text-decoration: none; color: var(--red); }

    /* Footer */
    footer {
      grid-column: 2; padding: 2rem 5rem;
    ...
    .hero-enter { opacity: 0; animation: fadeUp 0.7s ease 0.1s forwards; }
    ...
    @media (max-width: 900px) {
      ...
      .sidebar {
        ...
        align-items: center; padding: 1.5rem 2rem; gap: 1.5rem;
      }
      ...
      .main { grid-column: 1; grid-row: 2; padding: 3rem 2rem; max-width: 100%; }
      footer { grid-column: 1; padding: 1.5rem 2rem; }
      ...
      <div class="pub-list">
        ...
        <div class="pub-item">
          ...
          <div class="pub-body">
            ...
            <div class="pub-links">
              <a class="badge-arxiv" href="https://arxiv.org/abs/2603.19180" target="_blank" rel="noopener">arXiv · 2603.19180</a>
            </div>
          </div>
        </div>
        ...
        <div class="pub-item">
          ...
          <div class="pub-body">
            ...
            <div class="pub-links">
              <a class="badge-arxiv" href="https://arxiv.org/abs/2512.07164" target="_blank" rel="noopener">arXiv · 2512.07164</a>
            </div>
          </div>
        </div>
